...
$feature = [
    ...
    ["number" => "3. Krok", "btn" => "Znajdź specjalistę", "href" => "/", "desc" => "Diagnostyka ze specjalistą", "header" => "Zalecana diagnoza ADHD", "text" => "Preferowaną metodą diagnozy ADHD jest starannie przeprowadzony wywiad kliniczny. Może mieć formę swobodną lub ustrukturyzowaną, np. kwestionariusz DIVA-5. Wywiad powinien prowadzić doświadczony klinicysta, pozyskując informacje z różnych źródeł.", "svg" => '<svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="-2 -2 24 24"><path fill="#17462B" d="M7 12.917v.583a4.5 4.5 0 1 0 9 0v-1.67a3.001 3.001 0 1 1 2 0v1.67a6.5 6.5 0 1 1-13 0v-.583A6 6 0 0 1 0 7V2a2 2 0 0 1 2-2h1a1 1 0 1 1 0 2H2v5a4 4 0 1 0 8 0V2H9a1 1 0 1 1 0-2h1a2 2 0 0 1 2 2v5a6 6 0 0 1-5 5.917M17 10a1 1 0 1 0 0-2a1 1 0 0 0 0 2"/></svg>'],
];
