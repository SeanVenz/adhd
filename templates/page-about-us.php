...
$feature = [
    ...
    ["header" => " Zaufane przez profesjonalistówi użytkowników", "text" => "Nasza platforma jest wykorzystywana przez rodziny, nauczycieli i specjalistów ds. zdrowia psychicznego na całym świecie jako wiarygodne narzędzie do zrozumienia i zarządzania ADHD.", "svg" => '<svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24"><path fill="#17462B" fill-rule="evenodd" d="M12.05 1.25h-.1c-.664 0-1.237 0-1.696.062c-.491.066-.963.215-1.345.597s-.531.854-.597 1.345c-.062.459-.062 1.032-.062 1.697v2.427a2.3 2.3 0 0 0-.75-.128h-3A2.25 2.25 0 0 0 2.25 9.5v11.75H2a.75.75 0 0 0 0 1.5h20a.75.75 0 0 0 0-1.5h-.25V14.5a2.25 2.25 0 0 0-2.25-2.25h-3q-.396.002-.75.128V4.951c0-.665 0-1.238-.062-1.697c-.066-.491-.215-.963-.597-1.345s-.853-.531-1.345-.597c-.459-.062-1.032-.062-1.697-.062m8.2 20V14.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75v6.75zm-6 0V5c0-.728-.002-1.2-.048-1.546c-.044-.325-.115-.427-.172-.484s-.159-.128-.484-.172c-.347-.046-.818-.048-1.546-.048s-1.2.002-1.546.048c-.325.044-.427.115-.484.172s-.128.159-.172.484c-.046.347-.048.818-.048 1.546v16.25zm-6 0V9.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75v11.75z" clip-rule="evenodd"/></svg>'],
        ...
        <div class="min-width">
            <div class="hero-holder">
                <div class="text-holder">
                    <h1>Kim jesteśmy</h1>
                    <span>Zaangażowani w klarowność, oddani zrozumieniu</span>
                    <p>Jesteśmy zespołem ekspertów, edukatorów i rzeczników, których pasją jest dostarczanie jasnych,
                        dostępnych i opartych na nauce ocen ADHD. Naszą misją jest zapewnianie rzetelnych informacji i
                        praktycznych wskazówek, aby osoby i rodziny mogły z pewnością nawigować w świecie ADHD.</p>
                    <ul>
            ...
            <div class="history-holder">
                ...
                <div class="desc">
                    ...
                    <p>Założona na zasadach innowacji, wiedzy i empatii, nasza podróż rozpoczęła się od prostego celu:
                        uczynienia oceny ADHD bardziej dokładną, dostępną i łatwą do zrozumienia. Zauważyliśmy, że wiele
                        istniejących metod jest zbyt skomplikowanych, kosztownych lub nie zapewnia wystarczającej
                        wiarygodności, aby podejmować świadome decyzje.</p>
